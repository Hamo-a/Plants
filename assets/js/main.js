...
// Slide Bar Toggle
const shopIcons = document.querySelectorAll(".shopping-basket");
...
shopIcons.forEach(icon => {
    ...
    icon.addEventListener("click", (e) => {
        ...
        const cart = icon.closest(".shoping_card").querySelector(".show_plants");
...
document.addEventListener("click", (e) => {
    ...
    document.querySelectorAll(".show_plants").forEach(cart => {
...
//   Basket Logic
const show = document.querySelectorAll(".shadow_plants_list");
